...
status_exitnode="#($CURRENT_DIR/scripts/tailscale_status_exitnode.sh)"
status_exitnode_interpolation="\#{tailscale_exitnode}"
...
do_interpolation(){
	...
	result=${result/$status_exitnode_interpolation/$status_exitnode}
